...
import { useAdminPendingNotifications, } from "../hooks/useAdminPendingNotifications.js";
...
export default function AppLayout({ children, mobileMenu }) {
  ...
  const notificationsCount =
    user?.role === "donor"
      ? donorNotificationData.unreadCount
      : user?.role === "super_admin"
        ? adminNotificationData.pendingCount
        : 0;
