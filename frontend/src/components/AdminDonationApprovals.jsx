...
export const AdminDonationApprovals = ({ onPendingCountChange, }) => {
    ...
    useEffect(() => {
        onPendingCountChange?.(pendingDonations.length);
    }, [pendingDonations, onPendingCountChange,]);
            ...
            async ({ showLoader = false, } = {}) => {
                ...
                try {
                    ...
                    if (
                        ...
                        window.setTimeout(() => {
                            fetchPendingDonations({ showLoader: false, });
                        },
                            0
                        );
                    }
    ...
    const broadcastPendingUpdate = () => {
        window.dispatchEvent(
            new CustomEvent("pending-donations-updated")
        );
